...
public partial class TallerMotosContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCargo).HasName("PK__Cargos__3D0E29B83E03E691");
        ...
        {
            entity.HasKey(e => e.IdCliente).HasName("PK__Clientes__885457EE82F2C3CE");
        ...
        {
            entity.HasKey(e => e.IdDetalleFac).HasName("PK__Detalle___B2F5043B32370556");
        ...
        {
            entity.HasKey(e => e.IdEmpleado).HasName("PK__Empleado__5295297C84B51BD7");
        ...
        {
            entity.HasKey(e => e.IdFactura).HasName("PK__Factura__3CD5687E3B53D146");
        ...
        {
            entity.HasKey(e => e.IdMotocicleta).HasName("PK__Motocicl__EE98DCEBFE8C347B");
        ...
        {
            entity.HasKey(e => e.IdServicio).HasName("PK__Servicio__CEB98119253619E2");
        ...
        {
            entity.HasKey(e => e.IdServicioCli).HasName("PK__Servicio__E784F158DDD76349");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6601F1D23");
